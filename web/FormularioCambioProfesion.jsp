    ...
    <body>
        ...
        <div class="w3ls-header">
            ...
            <div class="header-main">
                <h2>Cambiar Profesión</h2>
                <div class="header-bottom">
                    <div class="header-right w3agile">
                        <div class="header-left-bottom agileinfo">
                            <form action="cambiarProfesion.do" method="post" class="form-register" onsubmit="return validar();">
                                <div class="icon1">
                                  ...
                                  <div class="icon1">
                                    ...
                                    <input type="text" id="profesion" name="nuevaProfesion" placeholder="Nueva Profesión"  required>
                                </div>
                                <div class="bottom" >
